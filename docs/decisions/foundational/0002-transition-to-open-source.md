...
* It has been decided that nubarchiva will become a full open-source solution.
...
* To ensure a smooth transition, gradually migrate the functionalities from nubarchiva version 2 to
  ...
  Instead, the code migrated to version 3 can be used in version 2.

### Consequences

* Badly, having "live" both versions can constrain the decision-making process in open-source
